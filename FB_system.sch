...
F {}
E {}
P 4 5 -2850 -2200 -2300 -2200 -2300 -1900 -2850 -1900 -2850 -2200 {}
P 4 5 -1815 -2410 -1635 -2410 -1635 -2270 -1815 -2270 -1815 -2410 {}
T {DUMMIES} -2845 -2230 0 0 0.4 0.4 {}
T {POWER SUPPLY} -1815 -2440 0 0 0.4 0.4 {}
...
N -1730 -1760 -1690 -1760 {lab=vdda}
N -1730 -1820 -1690 -1820 {lab=vdda}
N -1730 -1880 -1690 -1880 {lab=vdda}
N -1730 -1940 -1690 -1940 {lab=vdda}
...
N -1690 -2000 -1580 -2000 {lab=vdda}
N -1770 -1370 -1690 -1370 {lab=V_mem}
N -2500 -2130 -2480 -2130 {lab=vdda}
N -2500 -2180 -2500 -2160 {lab=vdda}
N -2550 -2130 -2540 -2130 {lab=vdda}
N -2550 -2160 -2550 -2130 {lab=vdda}
N -2550 -2160 -2500 -2160 {lab=vdda}
N -2500 -2100 -2500 -2080 {lab=out}
N -2370 -2130 -2350 -2130 {lab=vdda}
N -2370 -2180 -2370 -2160 {lab=vdda}
N -2420 -2130 -2410 -2130 {lab=vdda}
N -2420 -2160 -2420 -2130 {lab=vdda}
...
C {lab_wire.sym} -1580 -2050 0 0 {name=p6 sig_type=std_logic lab=vdda}
...
C {sg13g2_pr/sg13_hv_pmos.sym} -2520 -2130 0 0 {name=Mdum6
l=2u
w=1u
ng=1
m=2
...
C {lab_wire.sym} -2500 -2180 0 0 {name=p28 sig_type=std_logic lab=vdda}
C {lab_wire.sym} -2500 -2080 0 0 {name=p29 sig_type=std_logic lab=out}
C {sg13g2_pr/sg13_hv_pmos.sym} -2390 -2130 0 0 {name=Mdum7
l=2u
w=1u
ng=1
m=1
...
C {lab_wire.sym} -2370 -2180 0 0 {name=p31 sig_type=std_logic lab=vdda}
C {lab_wire.sym} -2370 -2080 0 0 {name=p32 sig_type=std_logic lab=V_mem}
C {sg13g2_pr/sg13_hv_nmos.sym} -2490 -1980 0 0 {name=Mdum1
l=2u
w=2u
ng=2
m=1
...
C {lab_wire.sym} -2470 -1930 0 0 {name=p17 sig_type=std_logic lab=out
}
C {lab_wire.sym} -2470 -2030 0 0 {name=p18 sig_type=std_logic lab=vssa
}
C {iopin.sym} -1675 -2380 1 0 {name=p39 lab=vssa}
C {iopin.sym} -1745 -2380 1 0 {name=p40 lab=vdda}
C {lab_wire.sym} -1570 -1760 1 0 {name=p41 sig_type=std_logic lab=Vmir}
C {lab_wire.sym} -1470 -1060 2 0 {name=p3 sig_type=std_logic lab=vssa}
C {lab_wire.sym} -2450 -1980 0 1 {name=p5 sig_type=std_logic lab=vssa}
C {lab_wire.sym} -2480 -2130 0 1 {name=p8 sig_type=std_logic lab=vdda}
C {lab_wire.sym} -2350 -2130 0 1 {name=p27 sig_type=std_logic lab=vdda}
C {lab_wire.sym} -1730 -1940 0 0 {name=p7 sig_type=std_logic lab=vdda}
C {lab_wire.sym} -1730 -1880 0 0 {name=p9 sig_type=std_logic lab=vdda}
C {lab_wire.sym} -1730 -1820 0 0 {name=p10 sig_type=std_logic lab=vdda}
C {lab_wire.sym} -1730 -1760 0 0 {name=p11 sig_type=std_logic lab=vdda}
C {lab_wire.sym} -1430 -1760 0 1 {name=p12 sig_type=std_logic lab=vdda}
C {lab_wire.sym} -1440 -1530 0 1 {name=p13 sig_type=std_logic lab=vdda}
C {lab_wire.sym} -1440 -1370 0 1 {name=p4 sig_type=std_logic lab=vssa}
