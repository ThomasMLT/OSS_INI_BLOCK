...
N 390 180 390 210 {lab=en_VSB[10:8]}
N 300 180 300 210 {lab=en_VS[10:8]}
...
N 2660 -360 3180 -360 {lab=bias_VP}
N 1680 -360 1680 -320 {lab=bias_VP}
N 1820 -360 1820 -320 {lab=bias_VP}
N 1680 -360 1820 -360 {lab=bias_VP}
N 1960 -360 1960 -320 {lab=bias_VP}
N 1820 -360 1960 -360 {lab=bias_VP}
N 2100 -360 2100 -320 {lab=bias_VP}
N 1960 -360 2100 -360 {lab=bias_VP}
N 2240 -360 2240 -320 {lab=bias_VP}
N 2100 -360 2240 -360 {lab=bias_VP}
N 2380 -360 2380 -320 {lab=bias_VP}
N 2240 -360 2380 -360 {lab=bias_VP}
N 2520 -360 2520 -320 {lab=bias_VP}
N 2380 -360 2520 -360 {lab=bias_VP}
N 2660 -360 2660 -320 {lab=bias_VP}
N 2520 -360 2660 -360 {lab=bias_VP}
...
N 2740 360 3440 360 {lab=vssa}
N 3300 110 3300 250 {lab=#net6}
N 3300 110 3360 110 {lab=#net6}
...
N 3320 -540 3320 -360 {lab=bias_VP}
...
N 3300 20 3440 20 {lab=#net6}
N 3180 -660 3440 -660 {lab=vdda}
N 3410 170 3440 170 {lab=vssa}
N 1070 60 1100 60 {lab=vssa}
N 840 190 870 190 {lab=vssa}
N 3220 -540 3320 -540 {lab=bias_VP}
N 3220 -570 3220 -540 {lab=bias_VP}
N 3320 -550 3320 -540 {lab=bias_VP}
N 3320 -540 3400 -540 {lab=bias_VP}
N 3400 -570 3400 -540 {lab=bias_VP}
N -40 -1480 10 -1480 {lab=vdda}
N -40 -1590 10 -1590 {lab=vdda}
N 10 -1590 10 -1560 {lab=vdda}
N 10 -1560 50 -1560 {lab=vdda}
N 50 -1590 50 -1560 {lab=vdda}
N 10 -1480 10 -1450 {lab=vdda}
N 10 -1450 50 -1450 {lab=vdda}
N 50 -1480 50 -1450 {lab=vdda}
...
C {lab_wire.sym} 300 210 3 0 {name=p6 sig_type=std_logic lab=en_VS[10:8]
}
C {lab_wire.sym} 390 210 1 1 {name=p10 sig_type=std_logic lab=en_VSB[10:8]
}
...
C {lab_wire.sym} 3580 -500 0 1 {name=p11 sig_type=std_logic lab=MASTER_CoreDiodeT_bias_VN[2]
}
C {cfringe34x70.sym} 3320 -610 2 1 {name=x3}
C {cfringe33x55.sym} 3300 340 0 0 {name=x2}
C {sg13g2_pr/sg13_hv_pmos.sym} 30 -1590 0 1 {name=M3
l=0.45u
w=4u
ng=1
m=2
...
C {sg13g2_pr/sg13_hv_pmos.sym} 30 -1480 0 1 {name=M4
l=0.45u
w=4u
ng=1
m=2
...
C {lab_wire.sym} -40 -1590 2 1 {name=p9 sig_type=std_logic lab=vdda
}
C {lab_wire.sym} -40 -1480 2 1 {name=p12 sig_type=std_logic lab=vdda
}
C {lab_pin.sym} 10 -1510 0 0 {name=p_en_cbb7 lab=bias_VN}
C {lab_pin.sym} 10 -1620 0 0 {name=p_en_cbb8 lab=bias_VP}
