...
N -490 -150 -230 -150 {lab=MASTER_bias_VN[0]}
N -490 10 -230 10 {lab=MASTER_bias_VN[1]}
N -490 170 -230 170 {lab=MASTER_bias_VN[2]}
N -490 330 -230 330 {lab=MASTER_bias_VN[3]}
N -490 650 -230 650 {lab=MASTER_bias_VN[5]}
N -490 810 -230 810 {lab=MASTER_bias_VN[6]}
N -490 970 -230 970 {lab=MASTER_bias_VN[7]}
...
N -490 490 -230 490 {lab=MASTER_bias_VN[4]}
