...
N -0 -60 60 -60 {lab=bulk}
N 0 -150 0 -90 {lab=#net2}
N -0 -170 60 -170 {lab=IO}
N -0 50 60 50 {lab=bulk}
N -0 80 -0 250 {lab=VSSA}
...
C {lab_pin.sym} 60 50 0 1 {name=p6 sig_type=std_logic lab=bulk}
C {lab_pin.sym} 60 -60 0 1 {name=p7 sig_type=std_logic lab=bulk}
C {iopin.sym} 60 -170 0 0 {name=p8 lab=bulk}
