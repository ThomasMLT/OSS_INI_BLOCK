...
N 160 -130 160 20 {lab=IREF_100nA}
N 400 -130 400 20 {lab=IREF_10nA}
N 640 -130 640 20 {lab=IREF_1nA}
N 880 -130 880 20 {lab=IREF_100pA}
N 1120 -130 1120 20 {lab=IREF_10pA}
N 1360 -130 1360 20 {lab=IREF_1pA}
N 1600 -130 1600 20 {lab=IREF_100fA}
...
N -1750 -160 -1670 -160 {lab=VBIAS}
N -1820 -10 -1750 -10 {lab=VBIAS}
N -1750 -160 -1750 -10 {lab=VBIAS}
N -1760 -160 -1750 -160 {lab=VBIAS}
N -2150 -160 -1920 -160 {lab=#net8}
...
C {iopin.sym} 160 20 1 0 {name=p24 lab=IREF_100nA}
C {iopin.sym} 400 20 1 0 {name=p8 lab=IREF_10nA}
C {iopin.sym} 640 20 1 0 {name=p9 lab=IREF_1nA}
C {iopin.sym} 880 20 1 0 {name=p10 lab=IREF_100pA}
C {iopin.sym} 1120 20 1 0 {name=p11 lab=IREF_10pA}
C {iopin.sym} 1360 20 1 0 {name=p12 lab=IREF_1pA}
C {iopin.sym} 1600 20 1 0 {name=p13 lab=IREF_100fA}
C {lab_wire.sym} -2250 20 1 0 {name=p15 sig_type=std_logic lab=VSSA}
C {iopin.sym} -1630 420 1 0 {name=p_vssa lab=VSSA}
C {iopin.sym} -2520 -30 2 0 {name=p16 lab=IREF_1uA}
...
C {lab_wire.sym} -1500 -340 1 0 {name=p_cbyp1_vssa sig_type=std_logic lab=VSSA}
...
C {ipin.sym} -1920 -130 0 0 {name=p_vref lab=VREF_100mV}
C {ipin.sym} -1920 -190 0 0 {name=p_vbptia lab=VBP_TIA}
...
C {inv_BG.sym} -2500 -330 0 0 {name=x10 spiceprefix=X}
C {lab_wire.sym} -2590 -260 1 0 {name=p_vssa3_wire sig_type=std_logic lab=VSSA}
