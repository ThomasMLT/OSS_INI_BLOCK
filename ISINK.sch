...
N 0 50 30 50 {lab=bulk}
N 0 -60 30 -60 {lab=bulk}
N 0 -170 30 -170 {lab=bulk}
...
C {lab_pin.sym} 30 -60 2 0 {name=p5 sig_type=std_logic lab=bulk}
C {lab_pin.sym} 30 50 2 0 {name=p7 sig_type=std_logic lab=bulk}
...
C {iopin.sym} 30 -170 0 0 {name=p9 lab=bulk}
